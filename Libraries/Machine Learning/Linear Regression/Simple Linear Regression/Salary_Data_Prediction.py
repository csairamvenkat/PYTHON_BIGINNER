...
model = pickle.load(open(r'C:\Users\sai.venkat\OneDrive\DataScience\Python\PYTHON_BIGINNER\Libraries\Machine Learning\Simple Linear Regression\linear_regression_model.pkl', 'rb'))
