...
survivedQ1 = titanic[(titanic["Embarked"] == "Q") & (titanic["Survived"] == 1)].shape[0]

# survivedQ and survivedQ1 gives same output
...
# For streamlit
fig, ax = plt.subplots()
ax.pie(chart, labels=labels, autopct='%1.1f%%', startangle=90, colors=colors, wedgeprops={'edgecolor': 'black'})
st.pyplot(fig)