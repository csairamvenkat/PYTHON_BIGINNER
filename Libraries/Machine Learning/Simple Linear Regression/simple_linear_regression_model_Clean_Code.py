...
# Load the dataset
dataset = pd.read_csv(r'C:\Users\sai.venkat\OneDrive\DataScience\Python\PYTHON_BIGINNER\Libraries\Machine Learning\Simple Linear Regression\Salary_Data.csv')
